            ...
            <div className="wibtnagreeP">
                <div className='mid'>
                  ...
                  <div className='btnright'>
                    <Button type="primary" htmlType="submit" onClick={handleAgree}>我已知悉並同意 隱私權政策</Button>
                  </div>
                </div>
            </div>
        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(PrivacyAgreement)